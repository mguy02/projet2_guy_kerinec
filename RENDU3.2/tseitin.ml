...
let tseitin (e:expr) (start_ind:int) : fnc =
	...
	(
		...
		let clause1 = ([-1*new_var; xip1],!current_number) in
		current_number := !current_number + 1;
		let clause2 = ([-1*new_var; xip2],!current_number) in
		current_number := !current_number + 1;
		let clause3 = ([new_var; -1*xip1; -1*xip2],!current_number) in
		current_number := !current_number + 1;
	...
	(
		...
		let clause1 = ([-1*xip1; new_var],!current_number) in
		current_number := !current_number + 1;
		let clause2 = ([-1*xip2; new_var],!current_number) in
		current_number := !current_number + 1;
		let clause3 = ([xip1; xip2; -1*new_var],!current_number) in
		current_number := !current_number + 1;
